...
public class UserController implements  IController {
    ...
    public void UpdateUser(User userDescriptor) {
        int dataIndex = this.GetUserIndex(userDescriptor.getID());
        _repository.UpdateRecord(dataIndex, userDescriptor.toString());
        _data.set(dataIndex, userDescriptor);
    }
